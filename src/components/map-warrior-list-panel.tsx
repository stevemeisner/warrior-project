...
export interface WarriorWithAccount {
  _id: string;
  accountId: string;
  name: string;
...
interface MapWarriorListPanelProps extends WarriorListProps {
  className?: string;
}

interface DesktopPanelProps extends MapWarriorListPanelProps {
  isCollapsed: boolean;
  setIsCollapsed: (isCollapsed: boolean) => void;
}

interface MobilePanelProps extends WarriorListProps {
